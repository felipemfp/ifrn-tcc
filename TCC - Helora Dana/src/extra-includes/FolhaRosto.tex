...
\titulo{\Large{Projeto e implementação de um robô que soluciona o problema do cubo de rubik usando Arduíno}}
\autor{Helora Dana Cruz Monteiro}
\orientador[Orientador]{\par Plácido Antonio de Souza Neto, Dr
...
\comentario
{
	...
	Sistemas.\bigskip\\
   \textit{Linha de pesquisa}:Desenvolvimento de Software, Hardware
}
