...
\newcommand{\myThesis}{An Spatial-Temporal Model for Highlighting Interesting Data over Time}
...
\include{capitulos/model}

\include{capitulos/collecting}

\include{capitulos/applying}

\include{capitulos/guiding}
